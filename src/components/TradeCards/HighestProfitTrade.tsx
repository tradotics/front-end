...
export default function HighestProfitTrade() {
  ...
  return (
    <div className="flex flex-col w-full h-full justify-center" onMouseEnter={()=>{setShowDetails(!showDetails)}} onMouseLeave={()=>{setShowDetails(!showDetails)}}>
      <div className="w-[70%] flex items-start justify-center text-primary"><h2 className="text-lg font-medium">Highest Profitable Trade</h2></div>
      <div className="flex justify-end items-center mb-2"><p className="text-xl text-success2 font-normal">$6013.50</p></div>
      { showDetails &&
      <React.Fragment>

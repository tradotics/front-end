  ...
  return (
    <div className='grid grid-cols-2 grid-rows-2'>
      <div className="row-span-2 col-span-1 flex justify-center items-end">
        <span className='text-primary sm:text-sm sm:font-semibold md:text-sm md:font-semibold lg:text-lg lg:font-bold '>Total Net P&L</span> </div>
      ...
      <div className="row-span-1 col-span-1 pl-3">
        <span className=' text-primary sm:text-xs sm:font-normal md:text-xs md:font-normal lg:text-sm lg:font-normal '>(IN 68 TRADES)</span>
      </div>
    </div>
  )
}
